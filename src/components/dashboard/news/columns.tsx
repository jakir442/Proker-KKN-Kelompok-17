...
interface ColumnProps {
    onEdit: (news: NewsColumn) => void;
    onDelete: (news: NewsColumn) => void;
    onPublish: (news: NewsColumn) => void;
}

export const columns = ({ onEdit, onDelete, onPublish }: ColumnProps): ColumnDef<NewsColumn>[] => [
    {
        accessorKey: "image",
        header: "Gambar",
        cell: ({ row }) => (
